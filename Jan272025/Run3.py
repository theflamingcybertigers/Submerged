...
async def main():
    ...
    #go to coral tree
    await gyro_straight_decel_tank(300, 0, -2.2, 450)
    #await runloop.sleep_ms(2000)
    await gyro_straight_tank (115, 0, 0.4, 100)
    #await runloop.sleep_ms(80)
    #await move_wall_vertical (580, 400, True)
    await move_wall_vertical (580, 1000, True)
    runloop.run(gyro_straight_tank(150, 0, -0.4, 80), move_wall_vertical(1450, 1000, True))
    await move_wall_vertical(300, -1000, True)
    #await gyro_straight_tank (-50, 0, 0.8, 200, True)
    #await runloop.sleep_ms(5000)
    #runloop.run(gyro_straight_tank(-600, 0, 2.6, 1000, True), move_wall_vertical(1790, -1000, True))
    runloop.run(motor_pair.move_for_degrees(motor_pair.PAIR_1, -850, -8, velocity=720), move_wall_vertical(1780, -1000, True))
